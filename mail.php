...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $recipient = "akingokal12345@gmail.com"; // Update to your desired email address.
    ...
    if (mail($recipient, $subject, $email_content, $email_headers)) {
        ...
        echo "Hoppla! Ein Fehler ist aufgetreten und Ihre Nachricht konnte nicht gesendet werden.";
    }
} else {
